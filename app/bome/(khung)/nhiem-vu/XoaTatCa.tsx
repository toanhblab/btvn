 ...
 *
 * @param total  tong so dong assignments trong DB — co the nhieu hon so bai dang
 *               hien tren man hinh, vi man nay chi liet ke 7 ngay quanh hom nay VA
 *               khong liet ke viec nha. Tu issue #36 viec nha cung la dong
 *               assignments that nen no nam trong con so nay: thao tac xoa that su
