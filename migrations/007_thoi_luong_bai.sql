...
--
-- Luc di tru nay chay: AI uoc luong theo do phuc tap va bi kep trong 5-15 phut
-- (lib/ai.ts); bo me sua tay thi duoc ghi gia tri ngoai khoang do. Khoang cua AI
-- doi theo thoi gian — doc lib/types.ts (clampDuration) de biet so hien tai.
-- Mac dinh 10 de moi bai cu
