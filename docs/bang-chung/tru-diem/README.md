...
| `05-bome-go-qua-so-moi-tru-het-5-dien-thoai.png` | Tầng giao diện của "không âm": chọn An (5 ⭐), gõ 8 → chữ đỏ "Con chỉ có 5 ⭐" **và** cái nút đổi luôn thành **"Trừ hết 5 ⭐"** (bấm được) — không phải nút khoá bắt bố mẹ gõ lại. Đây chỉ là **mặt nút**: bấm vẫn gửi đúng số 8 trong ô, máy chủ mới là chỗ kẹp lại (ảnh 06). |
