...
| `04-con-bena-khong-co-bai-chi-co-nhiem-vu-ipad.png` | Bé Na hôm nay không có bài (chỉ có bài ngày mai) nhưng vẫn có nhiệm vụ hôm nay; Bé Na không được giao "Đọc sách" nên không thấy. Tiến độ từng nhóm chỉ tính dòng của HÔM NAY: "Sau khi học xong 0/3 việc xong" (3 dòng "Ngày mai" vẫn hiện nhưng không đếm), "Việc nhà hàng ngày 0/1"; nhóm Smartkid chỉ có bài ngày mai nên không có chip tiến độ. Tick hết 3 việc hôm nay của nhóm đầu thì chip đọc "🎉 3/3 việc xong" và nền chuyển xanh (kiểm trực tiếp trên dev server). |
