...
Chụp ngày 2026-09-21 trên `next dev` cục bộ (`-H 0.0.0.0 -p 3100`), DB dev
...
| `sau-390-zalo-3-nguon-zalo.png` | Mục "Nhóm Zalo": hai nguồn, chọn con, cửa sổ nhận tệp, lần nhận gần nhất, công tắc bật/tắt. |
| `sau-1440-zalo-*.png` | Ba mục đó ở cỡ Macbook 1440×900. |
